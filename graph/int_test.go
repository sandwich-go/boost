...
func TestRectangleInt_SnakeRange(t *testing.T) {
	HelixRectRangeFromCenterAndMargin[int](P[int](2, 2), 2, func(p Point[int]) bool {
		t.Log(p.X(), p.Y())
		return true
	})
	...
	Convey("test intersection with line", t, func() {
		...
		So(r.Size().Equals(P[int](r3-r1, r4-r2)), ShouldBeTrue)
		rc := P[int](1, 1)
		rr := r.Add(rc)
		...
		So(rect.IntersectionWithLine(P[int](1, 0), P[int](1, 4)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](1, 0), P[int](1, 3)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](1, 0), P[int](1, 2)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](1, 0), P[int](1, 1)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](2, 0), P[int](2, 2)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](0, 2), P[int](1, 2)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](0, 1), P[int](3, 1)), ShouldBeTrue)  // should be true
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](0, 1)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](0, 2)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](0, 3)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](0, 4)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](1, 0)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 0), P[int](2, 0)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](1, 4), P[int](2, 4)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](0, 3), P[int](3, 3)), ShouldBeFalse) // should be false
		So(rect.IntersectionWithLine(P[int](1, 3), P[int](2, 4)), ShouldBeFalse) // should be false
	})
}
